...
?>
    ...
    <nav id="main-nav" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <?php if (isset($cover_thumb)): ?>
            <?php print $cover_thumb; ?>
          <?php endif ?>
          <?php if ($logo): ?>
        ...
        <div id="main-menus" class="collapse navbar-collapse">
    ...
    <div class="container main <?php print implode(' ', $classes_array); ?>">
      <?php if ($page['header']): ?>
        <header class="row">
          <div class="col-md-12">
      ...
      <div id="content" class="<?php print $content_width; ?>">
        <?php if ($page['highlighted']): ?>
          <div id="highlighted row">
